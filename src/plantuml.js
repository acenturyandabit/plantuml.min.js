// For more details on the cheerPJ filesystem, see
// https://cheerpj.com/docs/guides/File-System-support.html
export const makePlantuml = async (cheerpjPath = "/app/plantuml-wasm") => {
  await loadScript("https://cjrtnc.leaningtech.com/2.3/loader.js");
  await Promise.all([
  ...
  await cheerpjRunMain(
    "com.plantuml.wasm.v1.RunInit",
    `${cheerpjPath}/plantuml-core.jar`,
    `${cheerpjPath}/`
  );

  return {
    renderPng: async (pumlContent) => {
      const renderingStartedAt = new Date();
      const temporaryResultFilename = `result-${renderingStartedAt
        .getTime()
        .toString()}.png`;
      const cjCallResult = JSON.parse(
        await cjCall(
          "com.plantuml.wasm.v1.Png",
          "convert",
          "light",
          `/files/${temporaryResultFilename}`,
          pumlContent
        )
      );
      if (cjCallResult.status != "ok") {
        throw new Error(cjCallResult.error);
      }
      const blob = await cjFileBlob(temporaryResultFilename);
      const transaction = cheerpjGetFSMountForPath(
        "/files/"
      ).dbConnection.transaction("files", "readwrite");
      transaction.objectStore("files").delete(temporaryResultFilename);
    ...
    renderSvg: async (pumlContent) => {
      return await cjCall(
        "com.plantuml.wasm.v1.Svg",
        "convert",
        "light",
        pumlContent
      );
...
const _runtimeResources = () => {
  return [
    ...
    "/lt/runtime/rt.jar.sun.java2d.marlin.js",
    "/lts/rt.jar.c14.txt",
    "/lts/rt.jar.c15.txt",
    "/lts/rt.jar.c13.txt",
    "/lts/rt.jar.c12.txt",
    "/lt/cheerpj/lib/fonts/LucidaSansRegular.ttf",
    "/lts/rt.jar.c16.txt",
    "/lts/rt.jar.c17.txt",
    "/lts/rt.jar.c29.txt",
    "/lts/rt.jar.c30.txt",
    ...
    "/lts/rt.jar.c10.txt",
    "/lts/rt.jar.c8.txt",
    "/lt/cheerpj/lib/fonts/badfonts.txt",
    "/lt/cheerpj/lib/fonts/index.list",
    "/lt/cheerpj/lib/fonts/fallback",
    "/lt/cheerpj/fontconfig.properties",
    "/lt/cheerpj/DejaVuSans.ttf",
    "/lt/runtime/rt.jar.java.nio.js",
    "/lt/runtime/rt.jar.sun.nio.cs.js",
    "/lts/rt.jar.c20.txt",
    "/lts/rt.jar.c21.txt",
    "/lts/rt.jar.c19.txt",
    "/lt/runtime/rt.jar.javax.imageio.js",
    "/lt/runtime/rt.jar.com.sun.imageio.js",
    "/lt/runtime/rt.jar.com.sun.imageio.plugins.jpeg.js",
